...
# Dijkstra — On the foolishness of "natural language programming" (EWD 667)

Transcription provided in chat (original attributed to EWD 667; transcribed by Tristram Brelstaff; revised Fri, 19 Nov 2010).

## Key excerpt / notes

- Takeaway: formal systems are **nonsense filters** — they reject lots of bad statements early because legitimacy reduces to a few simple rules.
- Natural language is permissive: it makes it easy to produce statements whose nonsense isn’t immediately obvious.
- Switching to a wider interface doesn’t just shift labour; it adds coordination/translation work across the interface.
