...
- [x] `nano`: simple editor
- [x] `ed`: line editor (for scripts)
...
- [ ] `msgcomm`
- [ ] `ngettext`
- [ ] `envsubst`: (envsubst is useful — listed in tier 2)
- [ ] `autopoint`
...
- [ ] `espeak-ng`
- [ ] `flite`
- [ ] `flite_cmu_us_kal`: ... and other flite voices
- [ ] `flite_cmu_us_slt`: ... and other flite voices
